...
namespace MultiTrack.Models
{
    public static class LanguageHelper
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            ...
            { "Total", new() { { "TR", "Toplam" }, { "EN", "Total" }, { "RU", "Всего" } } },
            { "Average", new() { { "TR", "Ortalama" }, { "EN", "Average" }, { "RU", "Среднее" } } },
            { "Completed", new() { { "TR", "Tamamlanan" }, { "EN", "Completed" }, { "RU", "Выполнено" } } },
            { "SuccessRate", new() { { "TR", "Başarı Oranı" }, { "EN", "Success Rate" }, { "RU", "Успешность" } } },
            { "TransactionCount", new() { { "TR", "İşlem Sayısı" }, { "EN", "Transactions" }, { "RU", "Количество операций" } } },
            { "Book", new() { { "TR", "Kitap" }, { "EN", "Book" }, { "RU", "Книга" } } },
            { "Page", new() { { "TR", "Sayfa" }, { "EN", "Page" }, { "RU", "Страница" } } },
            { "Progress", new() { { "TR", "İlerleme" }, { "EN", "Progress" }, { "RU", "Прогресс" } } },
            { "CompletionRate", new() { { "TR", "Tamamlama Oranı" }, { "EN", "Completion Rate" }, { "RU", "Процент выполнения" } } },
            { "Items", new() { { "TR", "adet" }, { "EN", "items" }, { "RU", "шт." } } },
            { "PAZARTESİ", new() { { "TR", "Pazartesi" }, { "EN", "Monday" }, { "RU", "Понедельник" } } },
            { "SALI", new() { { "TR", "Salı" }, { "EN", "Tuesday" }, { "RU", "Вторник" } } },
            { "ÇARŞAMBA", new() { { "TR", "Çarşamba" }, { "EN", "Wednesday" }, { "RU", "Среда" } } },
            { "PERŞEMBE", new() { { "TR", "Perşembe" }, { "EN", "Thursday" }, { "RU", "Четверг" } } },
            { "CUMA", new() { { "TR", "Cuma" }, { "EN", "Friday" }, { "RU", "Пятница" } } },
            { "CUMARTESİ", new() { { "TR", "Cumartesi" }, { "EN", "Saturday" }, { "RU", "Суббота" } } },
            { "PAZAR", new() { { "TR", "Pazar" }, { "EN", "Sunday" }, { "RU", "Воскресенье" } } },
            { "ProfileSettings", new() { { "TR", "Profil Ayarları" }, { "EN", "Profile Settings" }, { "RU", "Настройки профиля" } } },
            { "Logout", new() { { "TR", "Çıkış Yap" }, { "EN", "Logout" }, { "RU", "Выйти" } } },
            { "EditProfileTitle", new() { { "TR", "Profili Güncelle" }, { "EN", "Update Profile" }, { "RU", "Обновить профиль" } } },
            { "NewEmailLabel", new() { { "TR", "Yeni E-posta" }, { "EN", "New Email" }, { "RU", "Новый Email" } } },
            { "NewPasswordLabel", new() { { "TR", "Yeni Şifre (Boş bırakılabilir)" }, { "EN", "New Password (Leave empty to keep same)" }, { "RU", "Новый пароль (Оставьте пустым, чтобы не менять)" } } },
            { "SaveChangesButton", new() { { "TR", "Değişiklikleri Kaydet" }, { "EN", "Save Changes" }, { "RU", "Сохранить изменения" } } },
            { "EmailInUseError", new() { { "TR", "Bu e-posta adresi zaten kullanımda." }, { "EN", "This email address is already in use." }, { "RU", "Этот адрес электронной почты уже используется." } } },
            { "ProfileUpdatedSuccess", new() { { "TR", "Profiliniz başarıyla güncellendi!" }, { "EN", "Profile updated successfully!" }, { "RU", "Профиль успешно обновлен!" } } },
            { "CurrentPasswordLabel", new() { { "TR", "Mevcut Şifre" }, { "EN", "Current Password" }, { "RU", "Текущий пароль" } } },
            { "ConfirmNewPasswordLabel", new() { { "TR", "Yeni Şifre Tekrar" }, { "EN", "Confirm New Password" }, { "RU", "Подтвердите новый пароль" } } },
            { "IncorrectCurrentPassword", new() { { "TR", "Mevcut şifreniz yanlış." }, { "EN", "Incorrect current password." }, { "RU", "Неверный текущий пароль." } } },
            { "NewPasswordsMismatch", new() { { "TR", "Yeni şifreler birbiriyle uyuşmuyor." }, { "EN", "New passwords do not match." }, { "RU", "Новые пароли не совпадают." } } },
            { "PasswordFieldsRequired", new() { { "TR", "Şifre değiştirmek için tüm şifre alanlarını doldurmalısınız." }, { "EN", "To change password, you must fill all password fields." }, { "RU", "Для изменения пароля необходимо заполнить все поля пароля." } } },
            { "ProfilePhotoLabel", new() { { "TR", "Profil Fotoğrafı" }, { "EN", "Profile Photo" }, { "RU", "Фото профиля" } } },
            { "ChooseFileLabel", new() { { "TR", "Dosya seç..." }, { "EN", "Choose a file..." }, { "RU", "Выберите файл..." } } },
            { "TotalPlansLabel", new() { { "TR", "Toplam Plan:" }, { "EN", "Total Plans:" }, { "RU", "Всего планов:" } } },
            { "NoBookAddedYet", new() { { "TR", "Henüz kitap eklenmedi." }, { "EN", "No book added yet." }, { "RU", "Книга еще не добавлена." } } },
            { "MovesLabel", new() { { "TR", "Hareket" }, { "EN", "Moves" }, { "RU", "Движений" } } },
            { "DarkModeLabel", new() { { "TR", "Gece Modu" }, { "EN", "Dark Mode" }, { "RU", "Темная тема" } } },
            { "LightModeLabel", new() { { "TR", "Gündüz Modu" }, { "EN", "Light Mode" }, { "RU", "Светлая тема" } } },
            { "WeeklyWorkoutPlan", new() { { "TR", "Haftalık Antrenman Planı" }, { "EN", "Weekly Workout Plan" }, { "RU", "План тренировок на неделю" } } },
            { "TodayBadge", new() { { "TR", "BUGÜN" }, { "EN", "TODAY" }, { "RU", "СЕГОДНЯ" } } }
        };
